        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                ...
                <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                    {room.images.length > 1 && room.images.map((image, index) => (
                        <img onClick={() => setMainImage(image)}
                            key={index} src={image} alt='room-image' className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image && " outline outline-3 outline-orange-500"}`}></img>
                    ))}
                </div>
            </div>
            {/* Room Highlights */}
            <div className='flex flex-col md:flex-row md:justify-between mt-6'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-wrap items-center mt-3 mb-0 gap-4 '>
                        {room.amenities.map((item, index) => (
                            <div key={index}
                                className='flex items-center gap-2 px-3 py-2 rounded-lg bg-black/50 hover:scale-105'>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                <button type='submit' className='bg-blue-500 hover:bg-primary-full active:scale-95 transition-all text-black rounded-md max-md:w-full max-md:mt-6 md:px-16 py-3 md:py-4 text-base cursor-pointer'>
                    Check Availability
                </button>
            </form>
            ...
            <div className='flex flex-col items-start gap-4'>
                ...
                <button className='px-6 py-2.5 mt-4 rounded text-white bg-blue-600 hover:bg-blue-300 transition-all cursor-pointer'>Contact Now</button>
            </div>
